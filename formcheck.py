...
Requiers some data in the ex config or dirconfig of a parent folder
    ...
    "nl": {
        ...
        "tests": {
            "checkCut": {
                ...
                "description": "Het gebruik van de cut (`!`) is niet toegelaten in deze oefening.",
                "treetext": "Red de bomen, gebruik geen cut <code>!</code>"
            },
            "checkCheat": {
                "title": "Valspeler",
